      ...
      <CardHeader className="pb-4">
        <CardTitle className="text-lg font-bold flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span>Últimas correcciones</span>
          </div>
          ...
          corrections.map((correction) => (
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 leading-tight mb-1 truncate max-w-[120px]">
                      {correction.writings.title || 'Escrito sin título'}
                    </h4>
                    <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 text-[10px] text-gray-400 font-medium">
                ...
                <span>{format(new Date(correction.created_at), 'd MMMM, yyyy', { locale: es })}</span>
              </div>
            </div>
          ))
        ) : (
          <div className="text-center py-6">
            <p className="text-sm text-gray-500 italic">Aún no tienes correcciones para mostrar</p>
          </div>
        )}
      </CardContent>
    </Card>
