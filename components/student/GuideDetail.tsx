  ...
  return (
    <div className="h-full flex flex-col bg-cream/30">
      <header className="p-8 bg-card border-b border-border">
        ...
        <h2 className="text-3xl font-display font-bold text-foreground mb-2">{guide.title}</h2>
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-3">
              {guide.structure.map((item, i) => (
                <div key={i} className="flex gap-4 p-4 bg-card rounded-xl border border-border shadow-sm">
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {guide.connectors.map((item, i) => (
                <Badge key={i} variant="secondary" className="bg-card border-accent/20 text-foreground/90 font-medium italic py-2 px-4 text-sm">
                  {item}
                </Badge>
              ))}
            </div>
      ...
      <footer className="p-6 bg-card border-t border-border mt-auto">
