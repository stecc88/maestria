          ...
          <>
            ...
            >
              <div className={cn(
                ...
                <span className="text-6xl font-display font-bold text-foreground">{count}</span>
                <span className="text-sm font-bold text-muted-foreground uppercase">Punti</span>
              </div>
              ...
              <Card className="bg-card border-border shadow-xl rounded-3xl overflow-hidden">
                <CardContent className="p-8">
                  <div className="flex items-start gap-4 text-left">
                    ...
                    <div>
                       <h4 className="font-bold text-foreground mb-2">Feedback dell&apos;Insegnante:</h4>
            ...
            >
              ...
              <Link href="/student/tasks" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full border-border hover:bg-muted font-bold py-6 px-10 rounded-2xl gap-2">
                  Vedi i compiti 📝
                </Button>
              </Link>
            </motion.div>
