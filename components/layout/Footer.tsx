      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-24">
          <div className="col-span-1 md:col-span-2 space-y-6">
            ...
            <p className="text-gray-400 font-bold text-lg italic max-w-sm">
          ...
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.2em] text-gray-900 mb-8">Piattaforma</h4>
          ...
          <div className="space-y-8">
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-gray-900 mb-8">Info</h4>
              <p className="font-bold text-sm text-gray-400 leading-relaxed">
