      ...
      >
        <div className="flex justify-center mb-10">
          <div className="relative">
            ...
            <div className="absolute -top-2 -right-2 p-2 bg-card rounded-full shadow-lg border border-border">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Button
              variant="outline"
              className="h-14 rounded-2xl border-border font-black uppercase text-xs tracking-widest text-muted-foreground hover:text-secondary hover:bg-secondary/5 hover:border-secondary/20 transition-all"
