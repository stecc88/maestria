    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="flex justify-center mb-10">
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute -top-2 -right-2 p-2 bg-white rounded-full shadow-lg border border-gray-100"
            >
        ...
        <motion.div
          ...
          className="p-8 bg-gray-50 rounded-[2rem] border-2 border-gray-100 mb-10 text-left relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 p-4 opacity-5">
             <AlertCircle className="h-20 w-20 text-gray-900" />
          </div>
          <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-secondary" />
            Motivazione Ufficiale
          </p>
          <p className="text-gray-700 font-black text-lg italic leading-relaxed relative z-10">
            &quot;{reason}&quot;
          </p>
        </motion.div>
