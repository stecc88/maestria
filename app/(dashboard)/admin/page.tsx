    ...
    <div className="relative min-h-screen">
      ...
      <div className="max-w-7xl mx-auto space-y-10 py-8 px-4 sm:px-6 lg:px-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats.map((stat, i) => (
            <Card key={stat.label} className="group relative overflow-hidden border-none shadow-xl shadow-gray-200/50 bg-white rounded-[2rem] hover:shadow-2xl transition-all duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="space-y-4">
              {pendingUsers && pendingUsers.length > 0 ? (
                pendingUsers.map((user, i) => (
                  <Card key={user.id} className="group border-none shadow-lg shadow-gray-200/50 bg-white rounded-[2rem] hover:shadow-xl transition-all duration-300 overflow-hidden">
                    <CardContent className="p-8">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex items-start gap-5">
                          <div className="h-14 w-14 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/5 transition-colors">
                            <User className="h-7 w-7 text-gray-400 group-hover:text-primary transition-colors" />
                          </div>
                          <div>
                            <h3 className="text-xl font-black text-gray-900 tracking-tight mb-2 group-hover:text-primary transition-colors">{user.full_name}</h3>
                ...
                <div className="text-center py-20 bg-white/50 rounded-[3rem] border-4 border-dashed border-gray-100">
                  <UserCheck className="h-16 w-16 text-gray-200 mx-auto mb-6" />
                  <p className="text-gray-400 font-black uppercase tracking-widest">Nessuna approvazione pendente</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-10">
            <Card className="border-none shadow-2xl shadow-blue-500/10 bg-white overflow-hidden rounded-[2.5rem] group relative">
              ...
              <CardHeader className="p-10 pb-4">
                ...
                <CardTitle className="text-2xl font-black text-gray-900 tracking-tight">Gestione Utenti</CardTitle>
              </CardHeader>
            ...
            <Card className="border-none shadow-xl shadow-primary/10 bg-gradient-to-br from-primary/10 to-accent/10 p-8 rounded-[2.5rem] relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-black text-gray-900 tracking-tight">Consiglio Admin</h3>
              </div>
              <p className="text-sm text-gray-600 font-bold leading-relaxed relative z-10">
