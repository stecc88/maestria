    ...
    <div className="relative min-h-screen">
      ...
      <div className="max-w-7xl mx-auto space-y-10 py-8 px-4 sm:px-6 lg:px-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-4 p-5 bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-50 group hover:scale-105 transition-transform duration-300">
            <div className="p-3 bg-primary/10 rounded-2xl group-hover:rotate-12 transition-transform">
              <Users className="h-6 w-6 text-primary" />
            </div>
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Codice Classe</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-8 space-y-10">
            ...
            <Card className="border-none shadow-xl shadow-gray-200/50 bg-white overflow-hidden rounded-[2rem] group">
              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead>
                      <tr className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] border-b border-gray-50 bg-gray-50/20">
                          ...
                          <tr key={student.id} className="hover:bg-primary/5 transition-all group/row">
                            ...
                            <td className="px-8 py-5 text-right">
                              <Link href={`/teacher/students/${student.id}`}>
                                <Button size="icon" className="rounded-xl bg-gray-50 hover:bg-primary text-gray-400 hover:text-white h-10 w-10 transition-all shadow-sm group-hover/row:shadow-lg group-hover/row:-translate-y-1">
                  ...
                  <div className="divide-y divide-gray-50">
                     {notifications?.map((n, i) => (
                       <div key={n.id} className="p-6 hover:bg-accent/5 transition-all group/n">
                          <p className="text-sm font-black text-gray-900 group-hover/n:text-primary transition-colors leading-snug">{n.title}</p>
                          <p className="text-[11px] text-gray-500 font-medium mt-2 line-clamp-2 leading-relaxed">{n.message}</p>
                          <div className="flex items-center gap-2 text-[10px] text-gray-400 mt-4 font-black uppercase tracking-widest">
             ...
             <Card className="border-none shadow-2xl shadow-primary/20 bg-gray-900 text-white overflow-hidden rounded-[2.5rem] relative group">
                ...
                <CardContent className="p-10 relative z-10 space-y-6">
                  ...
                  <Link href="/teacher/tasks" className="block">
                    <Button className="w-full bg-white text-gray-900 hover:bg-gray-100 font-black h-14 rounded-2xl text-xs tracking-[0.2em] shadow-xl group-hover:translate-y-[-2px] transition-all">
                       VAI AI COMPITI
                    </Button>
                  </Link>
                </CardContent>
